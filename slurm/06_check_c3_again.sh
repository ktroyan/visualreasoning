...
configs=(
  "BEFOREARC compositionality exp_setting_3 experiment_1 1997"
  "BEFOREARC compositionality exp_setting_3 experiment_2 1997"
  "BEFOREARC compositionality exp_setting_3 experiment_3 1997"
  "BEFOREARC compositionality exp_setting_3 experiment_4 1997"
  "BEFOREARC compositionality exp_setting_3 experiment_5 1997"
  "BEFOREARC compositionality exp_setting_3 experiment_1 42"
  "BEFOREARC compositionality exp_setting_3 experiment_2 42"
  "BEFOREARC compositionality exp_setting_3 experiment_3 42"
  "BEFOREARC compositionality exp_setting_3 experiment_4 42"
  "BEFOREARC compositionality exp_setting_3 experiment_5 42"
  "BEFOREARC compositionality exp_setting_3 experiment_1 2025"
...
for config in "${configs[@]}"; do
  ...
  sbatch run_experiment.submit \
    ...
    wandb.wandb_project_name=VisReas-project-${data_env}-llada-C3-check \
